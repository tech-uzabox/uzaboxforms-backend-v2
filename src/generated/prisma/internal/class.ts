...
/**
  ...
  /**
   * `prisma.certificateFieldMapping`: Exposes CRUD operations for the **CertificateFieldMapping** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more CertificateFieldMappings
    * const certificateFieldMappings = await prisma.certificateFieldMapping.findMany()
    * ```
    */
  get certificateFieldMapping(): Prisma.CertificateFieldMappingDelegate<ExtArgs, { omit: OmitOpts }>;
